...
def table_hospital():
    try:
        conn = py.connect(host='localhost', port=3306, user='root', password='123', db='only2days')
        cmd = conn.cursor()
        q = "create table hospital(hospUsername varchar(45) primary key,hospname varchar(45),hospname varchar(45),hospemail varchar(60),hospmob numeric(15),hospyoe integer,hospapec varchar(60),hospadd varchar(100),hospstate varchar(45),hospcity varchar(45),hoappwd varchar(45))"
        cmd.execute(q)
...
def put_patient():
    try:
        ...
        q = "insert into patient(patientfname,patientlname,patientemail,patientgender,patientdob,patientbg,patientmob,patientadd,patientstate,patientcity,patientpwd) values('{}','{}','{}','{}','{}','{}',{},'{}','{}','{}','{}')".format(pfn,pln,pe,pg,pdob,pbg,pmo,pa,ps,pc,pwd)
        print(q)
        cmd.execute(q)
...
def put_doctor():
    try:
        ...
        q = "insert into doctor(doctorfname,doctorlname,doctoremail,doctorgender,doctordob,doctormob,doctorexp,doctorgedu,doctorspec,doctoradd,doctorstate,doctorcity,doctorpwd) values('{}','{}','{}','{}','{}',{},{},'{}','{}','{}','{}','{}','{}')".format(dorfn,dorln,dore,dorg,dordob,dmo,dexp,dedu,dspec,dadd,dst,dorc,dpwd)
        print(q)
        cmd.execute(q)
...
def put_hospital():
    try:
        ...
        q = "insert into hospital(hospname,ohospname,hospemail,hospmob,hospyoe,hospapec,hospadd,hospstate,hospcity,hoappwd) values('{}','{}','{}',{},{},'{}','{}','{}','{}','{}')".format(hosn,ohons,hosemail,hosmo,hosyoe,hosspec,hosadd,hosstate,hoscity,hospwd)
        print(q)
        cmd.execute(q)
